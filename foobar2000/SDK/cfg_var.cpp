...
namespace cfg_var_modern {
	...
	void cfg_string::set_data_raw(stream_reader* p_stream, t_size, abort_callback& p_abort) {
	...
	void cfg_bool::set_data_raw(stream_reader* p_stream, t_size, abort_callback& p_abort) {
		uint8_t b;
