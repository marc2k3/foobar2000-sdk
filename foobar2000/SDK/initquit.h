#pragma once
//! Basic callback startup/shutdown callback, @c on_init is called after the main window has been created, @c on_quit is called before the main window is destroyed. \n
...
//! Helper for @c FB2K_RUN_ON_INIT_QUIT()
...
//! Helper for @c FB2K_ON_INIT_STAGE
...
//! Helper macro to skip implementing @c init_stage_callback.\n
//! Usage: \n
//! `void myfunc() {...}` \n
