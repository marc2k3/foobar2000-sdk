...
//! To access existing unpacker implementations, use @c unpacker::g_open helper function.\n
//! To register your own implementation, use @c unpacker_factory_t template.
class NOVTABLE unpacker : public service_base {
public:
	//! Attempts to open specified file for unpacking, creates interface to virtual file with uncompressed data on success. When examined file doesn't appear to be one of formats supported by this unpacker implementation, throws @c exception_io_data.
