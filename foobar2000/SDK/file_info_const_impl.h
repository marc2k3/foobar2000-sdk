...
//! Special implementation of @c file_info that implements only const and copy methods. The difference between this and regular @c file_info_impl is amount of resources used and speed of the copy operation.
class file_info_const_impl : public file_info_readonly
{
public:
